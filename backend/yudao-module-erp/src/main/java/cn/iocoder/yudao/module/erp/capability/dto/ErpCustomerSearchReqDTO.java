 ...
 */
@Data
public class ErpCustomerSearchReqDTO {

    @Size(max = 64)
    @CapabilityField(description = "客户名称关键词，模糊匹配；为空时返回最近创建的客户", example = "张三")
    private String keyword;

    @Size(max = 32)
    @CapabilityField(description = "手机号码，精确匹配；为空时不限制手机号", example = "15601691300")
